  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-14">
          <h2 className={` ${outfit.className} dark:text-white text-4xl md:text-5xl font-bold mb-4`}>
        ...
        <div className={`hidden ${outfit.className} lg:flex justify-around w-full h-0.5 bg-[#1f4e3d] dark:bg-teal-300 relative mb-50`}>
          {items.map((item, i) => (
            <div className="" key={i}>
              <div className="w-5 absolute -top-2 h-5 flex flex-col justify-center items-center bg-white border-2 dark:border-teal-300 border-[#1f4e3d] rounded-full">
                <div className="w-2 h-2 bg-[#1f4e3d] dark:bg-teal-300 rounded-full"></div>
              </div>
              <div className="w-0.5 h-10 ml-2 bg-[#1f4e3d] dark:bg-teal-300 mb-5"></div>
              <h1 className="-ml-5 text-6xl font-bold text-[#1f4e3d] dark:text-teal-300 mb-2">
                {item.year}
              </h1>
              <p className="-ml-5 text-2xl font-semibold text-gray-900 dark:text-white">
                {item.title}
              </p>
            </div>
          ))}
        ...
        <div className={`lg:hidden ${outfit.className} relative flex flex-col gap-5`}>
          <div className="absolute left-2 top-0 h-full w-0.5 dark:bg-teal-300 bg-[#1f4e3d]"></div>
          {items.map((item, i) => (
            <div className="flex flex-row items-start gap-10 relative" key={i}>
              <div className="w-5 h-5 mt-5 z-20 flex items-center justify-center bg-white dark:border-teal-300 border-2 border-[#1f4e3d] rounded-full">
                <div className="w-2 h-2 bg-[#1f4e3d] dark:bg-teal-300 rounded-full"></div>
              </div>
              <div className="w-12 -ml-10 h-0.5 bg-[#1f4e3d] dark:bg-teal-300 mt-7"></div>
              <div className="flex-1">
                <h1 className="text-4xl font-bold text-[#1f4e3d] dark:text-teal-300 mb-2">
                  {item.year}
                </h1>
                <p className="text-lg font-semibold text-gray-900 dark:text-teal-300 dark:text-white">
                  {item.title}
                </p>
              </div>
            </div>
