...
export  function Footer() {
  return (
    <footer className={`${outfit.className} bg-[#0f4a3a] text-white pt-20 pb-10 px-60 relative  overflow-hidden`}>

      
      <img
        src="flower-footer.png" 
         className="absolute bottom-0 left-0 w-60  lg:w-72 opacity-90 pointer-events-none"
      />

      
      <img
        src="
	https://agrica-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Fshape%2F7.png&w=1080&q=75" 
